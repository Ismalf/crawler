...
Use a simple CSV export for the product. Per requirements, the product is expected to retrieve a maximum of 30 entries at a time. As such, the current state of the product could be think of as a validation stage or MVP.
...
Actual product data structures are quite simple, which doesn't justify the extra infrastructure plus runtime overhead.
